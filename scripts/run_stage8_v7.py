...
mm  = joblib.load("data/processed/meta_models_robust_v7.joblib")
...
print("\n" + "═" * 110)
print("STAGE-8 MASTER ROBUSTNESS TABLOSU  (daylight, CQR k=2.0, meta_robust_v7)")
print("═" * 110)
header = (
...
plt.tight_layout()
fig.savefig("figures/robustness_v7_crps_bar.png", dpi=150)
fig.savefig("figures/robustness_v7_crps_bar.pdf")
plt.close(fig)
...
plt.tight_layout()
fig.savefig("figures/robustness_v7_heatmap.png", dpi=150)
fig.savefig("figures/robustness_v7_heatmap.pdf")
plt.close(fig)
...
ax.grid(axis="y", alpha=0.3)
plt.tight_layout()
fig.savefig("figures/robustness_v7_coverage.png", dpi=150)
fig.savefig("figures/robustness_v7_coverage.pdf")
plt.close(fig)
